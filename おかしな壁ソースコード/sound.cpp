...
CSound::PARAM CSound::m_aParam[CSound::SOUND_LABEL_MAX] =
{
	...
	{"DATA/SE/cursor-01.wav", 0},		// カーソル
	{"DATA/SE/kettei-02.wav", 0},		// 決定
	{"DATA/SE/cancel-02.wav", 0},		// キャンセル
	{"DATA/SE/footstep02.wav", 0},		// 歩く
	{"DATA/SE/jump_2.wav", 0},			// ジャンプ
	{"DATA/SE/switch01.wav", 0},		// スイッチ（押す）
	{"DATA/SE/battle18.wav", 0},		// スイッチ（壁消える）
	{"DATA/SE/jump11.wav", 0}			// スキル（スワップ?）
};
